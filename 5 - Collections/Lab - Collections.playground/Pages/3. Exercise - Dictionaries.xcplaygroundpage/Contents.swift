...
var dic : [String: Int] = ["jan": 31, "feb" : 28, "mar" : 31]
print(dic)
...
dic.updateValue(29, forKey: "feb")
print(dic)

//:  Use if-let syntax to retrieve the number of days under "January." If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
if(dic.keys.contains("jan")){
    if let days = dic["jan"] {
        print("okay \(days)")
    }
}
...
if let clrArray = dict["Colors"] {
    print(clrArray[clrArray.count - 1])
}
/*:
