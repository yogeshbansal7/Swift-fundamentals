 ...
 */
var walking = ["Walk 3 miles", "Walk 5 miles"]
var running = ["Run 5 miles", "Run 3 miles"]
...
var challenges : [[String]] = [walking, running]
print(challenges)
...
var commmitedChallenges = ["walk 10 miles", "Drinl 10 glasses of water", "Code on regular basis"]

//:  Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."

if(commmitedChallenges.isEmpty){
    print("commit some challenges")
}
else if(commmitedChallenges.count == 1){
    print("One challenge is commit \(commmitedChallenges[0])")
}
else{
    print("Commited more tan 1 challenges")
}
/*:
